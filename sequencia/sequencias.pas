...
type
  TformSequencias = class(TformCadModelo)
...
procedure TformSequencias.LerSequencia(var sequencia: longint);
begin
...
procedure TformSequencias.cdsDadosNewRecord(DataSet: TDataSet);
begin
  inherited;
