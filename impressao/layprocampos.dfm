inherited formProCampos: TformProCampos
  Caption = 'Campos do Produto'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited cdsDados: TClientDataSet
    CommandText = 
      'SELECT '#39'N'#39' AS SEL, PROC_PARAMS.* FROM PROC_PARAMS('#39'REL_NOTAPRO'#39')' +
      ' WHERE ENTSAI = '#39'S'#39
    ProviderName = 'pvProcampos'
  ...
  inherited dxComponentPrinter: TdxComponentPrinter
    inherited dxComponentPrinterLink1: TdxGridReportLink
      ReportDocument.CreationDate = 39476.756473738430000000
