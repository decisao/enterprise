inherited formImpMovDup: TformImpMovDup
  Caption = 'Layout Duplicatas do Movimento'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited cdsDados: TClientDataSet
    CommandText = 'SELECT '#39'N'#39' AS SEL, ITIMPNOTADUP.* FROM ITIMPNOTADUP'
    ProviderName = 'pvImpnotadup'
    Left = 536
    Top = 328
  ...
  inherited dxComponentPrinter: TdxComponentPrinter
    ...
    inherited dxComponentPrinterLink1: TdxGridReportLink
      ReportDocument.CreationDate = 39476.756354236110000000
