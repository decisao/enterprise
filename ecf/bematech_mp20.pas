...
function Bematech_FITEF_ConfiguraDiretorioTef( Path1: string; Path2: string): Integer; StdCall; External 'BEMAFI32.DLL';
function Bematech_FITEF_VendaCheque(Identificacao: string; ValorCompra: string): Integer; StdCall; External 'BEMAFI32.DLL';
function Bematech_FITEF_ApagaResiduos: Integer; StdCall; External 'BEMAFI32.DLL' Name 'Bematech_FITEF_ApagaResiduos';
