...
type
  TformGrupos = class(TformCadModelo)
...
procedure TformGrupos.LerSequencia(var sequencia: longint);
begin
...
procedure TformGrupos.cdsDadosNewRecord(DataSet: TDataSet);
begin
  inherited;
