inherited formSerCampos: TformSerCampos
  Caption = 'Campos do Servi'#231'o'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited cdsDados: TClientDataSet
    CommandText = 
      'SELECT '#39'N'#39' AS SEL, PROC_PARAMS.* FROM PROC_PARAMS('#39'REL_NOTASER'#39')' +
      ' WHERE ENTSAI = '#39'S'#39
    ProviderName = 'pvSercampos'
  ...
  inherited dxComponentPrinter: TdxComponentPrinter
    inherited dxComponentPrinterLink1: TdxGridReportLink
      ReportDocument.CreationDate = 39476.756521145840000000
